...
class Computer_Repair_Services_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function computer_repair_services_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function computer_repair_services_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function computer_repair_services_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function computer_repair_services_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->computer_repair_services_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function computer_repair_services_load( $class ) {
