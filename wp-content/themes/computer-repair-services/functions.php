...
function computer_repair_services_scripts() {
    ...
    wp_enqueue_script('computer-repair-services-theme-js', esc_url(get_template_directory_uri()) . '/assets/js/theme-script.js', array('jquery'), '', true );
...
add_action('after_switch_theme', 'computer_repair_services_setup_options');

function computer_repair_services_setup_options () {
	wp_redirect( admin_url() . 'themes.php?page=computer-repair-services-info.php' );
}
...
function computer_repair_services_info_page() {
	...
	<div class="wrap about-wrap computer-repair-services-add-css">
		<div>
			<h1>
				<?php esc_html_e('Welcome To ','computer-repair-services'); ?><?php echo esc_html( $theme ); ?>
			</h1>
