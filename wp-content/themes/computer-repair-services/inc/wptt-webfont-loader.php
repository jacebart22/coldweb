...
if ( ! class_exists( 'Computer_Repair_Services_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Computer_Repair_Services_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Computer_Repair_Services_WPTT_WebFont_Loader( $url );
